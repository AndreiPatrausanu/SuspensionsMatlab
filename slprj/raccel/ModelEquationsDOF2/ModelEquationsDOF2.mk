...
MODEL                   = ModelEquationsDOF2
MODULES                 = ModelEquationsDOF2.c ModelEquationsDOF2_capi.c ModelEquationsDOF2_data.c ModelEquationsDOF2_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = ModelEquationsDOF2.exe
MAKEFILE                = ModelEquationsDOF2.mk
MATLAB_ROOT             = D:\Matlab
ALT_MATLAB_ROOT         = D:\Matlab
START_DIR               = D:\MASTER\EvolutionaryComputing\MatlabSimulation
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 4
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = ModelEquationsDOF2_ref.rsp
COMPILER_COMMAND_FILE     = ModelEquationsDOF2_comp.rsp
