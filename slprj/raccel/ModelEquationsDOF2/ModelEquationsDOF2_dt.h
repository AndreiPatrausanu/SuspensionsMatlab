...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . daw4mlgab4 ) , 0 , 0 , 9 } ,
{ ( char_T * ) ( & rtDW . cfixiwqkrp ) , 0 , 0 , 4 } , { ( char_T * ) ( &
rtDW . hmomj45t1n . LoggedData ) , 11 , 0 , 14 } } ; static
DataTypeTransitionTable rtBTransTable = { 3U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP . cs ) , 0 ,
0 , 210 } } ; static DataTypeTransitionTable rtPTransTable = { 1U ,
rtPTransitions } ;
